 ...
 * @generated
 */
public class PipelineElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.PipelineElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "pipeline".equals(fileExtension); //$NON-NLS-1$
	}
