 ...
 * @generated
 */
public class PipelineViewProvider extends AbstractProvider implements
        IViewProvider {
    ...
    protected boolean provides(CreateNodeViewOperation op) {
        ...
        if (op.getSemanticHint() == null) {
            ...
            visualID = PipelineVisualIDRegistry.getNodeVisualID(
                    op.getContainerView(), domainElement);
        } else {
            visualID = PipelineVisualIDRegistry.getVisualID(op
                    .getSemanticHint());
            if (elementType != null) {
                if (!PipelineElementTypes.isKnownElementType(elementType)
                ...
                if (domainElement != null
                        && visualID != PipelineVisualIDRegistry
    ...
    public Node createNode(IAdaptable semanticAdapter, View containerView,
        ...
        if (semanticHint == null) {
            visualID = PipelineVisualIDRegistry.getNodeVisualID(containerView,
                    domainElement);
        } else {
        ...
        case DataManagementElementEditPart.VISUAL_ID:
            return createDataManagementElement_2006(domainElement,
                    containerView, index, persisted, preferencesHint);
        case SourceEditPart.VISUAL_ID:
            return createSource_2001(domainElement, containerView, index,
                    persisted, preferencesHint);
        case SinkEditPart.VISUAL_ID:
            return createSink_2002(domainElement, containerView, index,
                    persisted, preferencesHint);
        }
    ...
    public Edge createEdge(IAdaptable semanticAdapter, View containerView,
        ...
        case FlowEditPart.VISUAL_ID:
            return createFlow_4001(getSemanticElement(semanticAdapter),
                    containerView, index, persisted, preferencesHint);
        }
     ...
     * @generated
     */
    public Node createFamilyElement_2005(EObject domainElement,
     ...
     * @generated
     */
    public Node createDataManagementElement_2006(EObject domainElement,
            View containerView, int index, boolean persisted,
            PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
     ...
     * @generated
     */
    public Node createSink_2002(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        Shape node = NotationFactory.eINSTANCE.createShape();
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(PipelineVisualIDRegistry.getType(SinkEditPart.VISUAL_ID));
        ViewUtil.insertChildView(containerView, node, index, persisted);
        node.setElement(domainElement);
        stampShortcut(containerView, node);
        // initializeFromPreferences 
     ...
     * @generated
     */
    public Edge createFlow_4001(EObject domainElement, View containerView,
            int index, boolean persisted, PreferencesHint preferencesHint) {
        ...
        edge.setType(PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
    ...
    private void stampShortcut(View containerView, Node target) {
        if (!PipelineEditPart.MODEL_ID.equals(PipelineVisualIDRegistry
            ...
            shortcutAnnotation.getDetails().put(
                    "modelID", PipelineEditPart.MODEL_ID); //$NON-NLS-1$
