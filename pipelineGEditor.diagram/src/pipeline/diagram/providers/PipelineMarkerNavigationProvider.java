 ...
 * @generated
 */
public class PipelineMarkerNavigationProvider extends
        AbstractModelMarkerNavigationProvider {

    /**
     * @generated
     */
    public static final String MARKER_TYPE = PipelineDiagramEditorPlugin.ID
    ...
    protected void doGotoMarker(IMarker marker) {
        ...
        if (targetEditPart != null) {
            PipelineDiagramEditorUtil.selectElementsInDiagram(editor,
