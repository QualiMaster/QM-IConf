 ...
 * @generated
 */
public class DataManagementElementNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry
						.getType(pipeline.diagram.edit.parts.DataManagementElementNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public DataManagementElementNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new PipelineTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider
					.getParser(
							PipelineElementTypes.DataManagementElement_2006,
							getParserElement(),
							PipelineVisualIDRegistry
									.getType(pipeline.diagram.edit.parts.DataManagementElementNameEditPart.VISUAL_ID));
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					PipelineEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new DataManagementElementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DataManagementElementLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DataManagementElementLabelFigure() {
			this.setText("DataManagementElement");
		}
