 ...
 * @generated
 */
public class SourceEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SourceItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SourceNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineVisualIDRegistry
				.getType(SourceNameEditPart.VISUAL_ID));
	}
	...
	public class SourceFigure extends SVGFigure {
		 ...
		 */
		public SourceFigure() {
			this.setURI("platform:/plugin/pipelineGEditor/svg/source.svg");
