 ...
 * @generated
 */
public class FamilyElementNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry
						.getType(pipeline.diagram.edit.parts.FamilyElementNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public FamilyElementNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new FamilyElementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FamilyElementLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FamilyElementLabelFigure() {
			this.setText("FamilyElement");
		}
