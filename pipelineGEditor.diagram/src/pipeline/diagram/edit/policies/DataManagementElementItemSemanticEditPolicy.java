 ...
 * @generated
 */
public class DataManagementElementItemSemanticEditPolicy extends
		PipelineBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DataManagementElementItemSemanticEditPolicy() {
		super(PipelineElementTypes.DataManagementElement_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PipelineVisualIDRegistry.getVisualID(incomingLink) == FlowEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PipelineVisualIDRegistry.getVisualID(outgoingLink) == FlowEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
