...
public class PipelineNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, PipelineEditPart.MODEL_ID),
					file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PipelineEditPart.VISUAL_ID: {
			...
			PipelineNavigatorGroup links = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Pipeline_1000_links,
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					PipelineVisualIDRegistry
							.getType(FamilyElementEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					PipelineVisualIDRegistry
							.getType(DataManagementElementEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(SinkEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
		...
		case SourceEditPart.VISUAL_ID: {
			...
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Source_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Source_2001_outgoinglinks,
		...
		case SinkEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Sink_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Sink_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
		...
		case FamilyElementEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_FamilyElement_2005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_FamilyElement_2005_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
		...
		case DataManagementElementEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_DataManagementElement_2006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_DataManagementElement_2006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
		...
		case ReplaySinkEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_ReplaySink_2007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_ReplaySink_2007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					PipelineVisualIDRegistry.getType(FlowEditPart.VISUAL_ID));
		...
		case FlowEditPart.VISUAL_ID: {
			...
			PipelineNavigatorGroup target = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Flow_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup incominglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Flow_4001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup source = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Flow_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PipelineNavigatorGroup outgoinglinks = new PipelineNavigatorGroup(
					Messages.NavigatorGroupName_Flow_4001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
	 ...
	 * @generated
	 */
	private Collection<PipelineNavigatorItem> createNavigatorItems(
	 ...
	 * @generated
	 */
	private Collection<PipelineNavigatorItem> getForeignShortcuts(
