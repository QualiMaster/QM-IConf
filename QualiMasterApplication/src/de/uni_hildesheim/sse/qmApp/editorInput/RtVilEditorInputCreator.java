...
/**
 * Creates the editor input for the mail rt-VIL file.
 * 
 * @author Holger Eichelberger
 */
public class RtVilEditorInputCreator extends AbstractNonVariableEditorInputCreator {

    private IFile vilFile;

    /**
     * Creates a vil editor input creator.
     */
    public RtVilEditorInputCreator() {
        vilFile = ModelAccess.getMainRtVILfile();
    }
    
    @Override
    public IEditorInput create() {
        return new FileEditorInput(vilFile);
    }

    @Override
    public String getName() {
        return null == vilFile ? "" : vilFile.getName();
    }
