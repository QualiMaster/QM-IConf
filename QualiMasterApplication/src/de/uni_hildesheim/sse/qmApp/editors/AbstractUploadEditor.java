...
//                    // The container could be a deriveddatatype ->
//                    resolve to basis to be sure that we have a container
...
//                        if (null != refinedType) {
//                            
//                            //"name", "class" and "defaultValue" must not be changed, they are the names of the
//                              columns!
...
//                instances.put(variable.getNestedElement(1).getValue().getValue().toString(),
